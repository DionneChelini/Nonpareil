            ...
            <div className='lg:grid lg:grid-cols-2 lg:gap-6'>
              <div className='prose prose-indigo prose-lg text-gray-500 lg:max-w-none'>
                <p className='mt-8 text-lg text-gray-500'>
                  Our mission is to offer our clients unique, rare and
                  exceptional pieces of furniture that will compliment, enhance
                  and further stylise the aesthetics of their interior and
                  scheme, be residential or commericial.
                </p>
              </div>
            </div>
